...
pm_caption += "➥ **License** : [GNU General Public License v3.0](https://github.com/raman-nfx/FridayUserbot/blob/master/fridaybot/modules/alive.py)\n"
pm_caption += "➥ **Copyright** : By [NfxGang@Github](gitHub.com/Raman-Nfx)\n"
